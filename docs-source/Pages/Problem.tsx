  ...
  return (
    <Container sx={{ padding: 6 }} maxWidth={"lg"}>
      ...
      <Typography variant={"body1"}>
        ...
        controls when and how its state is updated. Since state is internal to every component, we have no direct way of
        synchronising state updates across components.
      </Typography>
      ...
      <section style={{ marginTop: theme.spacing(4) }}>
        ...
        <article>
          <Typography variant={"body1"}>
            ...
            boolean state variable. Imagine if there are multiple modals in your app that are opened at once as a result
            of some activity. Too hard to visualise? Try clicking the button below.
          </Typography>
